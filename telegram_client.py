...
def build_trading_autopilot_menu_keyboard() -> dict[str, Any]:
    return {
        "inline_keyboard": [
            ...
            [{"text": "🧪 Aggressive ON", "callback_data": "cmd:/testnet_aggressive_on"}],
            [{"text": "🧊 Aggressive OFF", "callback_data": "cmd:/testnet_aggressive_off"}],
            [{"text": "🧪 Aggressive Status", "callback_data": "cmd:/testnet_aggressive_status"}],
