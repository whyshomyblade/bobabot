...
def format_analytics(analysis: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"Estimated fee impact: {_fmt_r(-(_float(summary.get('fee_impact_total_r')) or 0))}",
        f"Average fee impact/setup: {_fmt_r(-(_float(summary.get('average_fee_impact_r')) or 0))}",
